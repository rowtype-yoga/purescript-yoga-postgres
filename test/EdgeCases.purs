...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- EDGE CASE 1: HAVING drops WHERE params
-- The having function replaces params rather than merging.
-- This means WHERE params get lost.
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

-- This SHOULD have params (age :: Int, minCount :: Int)
-- but having replaces WHERE params, giving only (minCount :: Int)
havingDropsWhereParams
  :: Q _ (name :: String, cnt :: Int) (minCount :: Int) _
havingDropsWhereParams = from usersTable
